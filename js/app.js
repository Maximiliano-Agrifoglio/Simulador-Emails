...
function eventListeners() {
    ...
    resetBtn.addEventListener('submit', resetearFormulario);
...
function enviarEmail(e) {
    ...
    spinner.style.display = 'flex';
        ...
        //ocultar el spinner despues de 3 segundos y mostrar el mensaje. 
    setTimeout(() => {
        ...
        //inserta en el parrafo antes del spinner.
